<nav class="admin-nav-l">
    <ul class="admin-ul">
        ...
        <li>
            <div class="icons-container">
                <img class="nav-icons" src="<?= $baseUrl . '/svg/keyboard.svg' ?>" alt="">
                <a href="#footer">Contact</a>
            </div>
        </li>
        <li>
            <div class="icons-container">
                <img class="nav-icons" src="<?= $baseUrl . '/svg/archive.svg' ?>" alt="">
                <a class="blog-link" href=<?= $baseUrl . "/" ?>>Business</a>
